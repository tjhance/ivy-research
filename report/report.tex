...
\chapter{Presentation of IVy}
    ...
    \begin{definition}[Structure \& State]
        ...
        \begin{itemize}
            \item For all \(s \in \text{sorts}\), \(D_s\) is a domain associated to the sort \(s\).
...
\chapter{Invariant synthesis}
    ...
    \end{definition}
    Thanks to the finite model property of EPR (section 1.3.2), we are always able to find a finite counterexample (i.e. a counterexample with finite domains) when the current invariant is not inductive
