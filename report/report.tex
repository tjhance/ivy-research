...
\chapter{Presentation of IVy}
    ...
    \end{definition}
    % TODO: also check safety properties
...
\chapter{Invariant synthesis}
    ...
    One possible way to sthrengthen an invariant \(I\) is to make the conjunction with its weakest precondition \(wpr(\text{action}_1|\ldots|\text{action}_n,I)\).
    ...
    We assume that the initial invariant \(I\) is correct. Let \(P = wpr(\text{action}_1|\ldots|\text{action}_n,I)\).
