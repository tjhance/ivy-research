...
\chapter{Invariant synthesis}
    ...
    \begin{enumerate}
        ...
        \item \textbf{Decidability}: Is the new invariant generated still checkable in a decidable way (in our case, we want it to be EPR)?
        \item \textbf{Simplicity}: Is the new invariant generated easily understandable by the user (in order to be adjusted if needed)?
    \end{enumerate}
    ...
    So \(P\) is a correct invariant and thus \(P \land I\) is also a correct invariant.\\
    ...
    \textbf{Simplicity}: Invariants generated are quite small and simple. They are more focused than weakest preconditions
...
\chapter{My contributions}
    ...
    \textbf{Simplicity}: Invariants generated are quite small and simple.
    
    % TODO: make comparative table
