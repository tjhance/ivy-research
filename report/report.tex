...
\chapter{Invariant synthesis}
    ...
    This invariant is not correct: for instance, the following state doesn't satisfy it and can be obtained through a valid execution.
    ...
    \begin{property}
        For monotonic counterexamples, the naive counterexample generalization method generates correct invariants.
        However, it can generate incorrect invariants for non-monotonic counterexamples.
    \end{property}
