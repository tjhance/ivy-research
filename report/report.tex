...
\chapter{Invariant Synthesis}
    ...
    % Can break decidability! (because forall quantifiers are added at the beginning by the process of wpr)
    % Characterize it? (see 'weakening the conjecture' section)
...
\chapter{My contributions}
    ...
    % Characterize it: decidable when studied invariant is universal only and axioms involved with mutation are existential only?
