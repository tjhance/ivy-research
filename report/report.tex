...
\chapter{My contributions}
    ...
    \begin{enumerate}
        ...
        However, the domains of \(S'\) can also contain some other elements.
        \item \(S'\) is a valid state (it can be obtained through a valid run).
    \end{enumerate}

    % Could use symbolic bounded verification

    Indeed, verifying the condition 2 is hard (it requires to use symbolic bounded verification), but we can also use this weaker condition instead:
