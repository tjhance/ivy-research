module Simplification
    ...
    let simplify_marks_hard (md:AST.ModuleDecl<'a,'b>) (mmd:MinimalAST.ModuleDecl<'a,'b>) (env:Model.Environment) (m:Synthesis.Marks) (alt_exec:List<Synthesis.Marks*Model.Environment>) =
        // TODO
        m